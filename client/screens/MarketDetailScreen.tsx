...
export default function MarketDetailScreen() {
  ...
  const handleSaveDoorCode = async () => {
    ...
    await updateDoorCode(
      market.id,
      `encrypted:${newDoorCode.trim()}`,
      user.id,
      user.name,
    );
      ...
      >
        ...
        >
          ...
          {market.doorCodes ? (
            ...
            <View style={styles.addCodeContainer}>
              <ThemedText
                style={[styles.noData, { color: theme.textSecondary }]}
              >
              ...
              >
                ...
                <ThemedText
                  style={[styles.addCodeText, { color: theme.primary }]}
                >
                  Code hinzufuegen
                </ThemedText>
              </Pressable>
        ...
        <InfoSection title="IT-Infrastruktur" icon="server">
          ...
          {market.switchRouterLocation ? (
            <InfoRow
              label="Switch/Router"
              value={market.switchRouterLocation}
              copyable
            />
          ) : null}
          {market.specialNotes ? (
              ...
              >
                <View style={styles.infoHeader}>
                  <View
                    style={[
                      styles.statusBadge,
                      { backgroundColor: theme.verified + "20" },
                    ]}
                  >
                  ...
                  <View style={styles.infoHeaderRight}>
                    <ThemedText
                      style={[styles.infoDate, { color: theme.textSecondary }]}
                    >
                ...
                {info.category === "barcode" && info.barcodeValue ? (
                  <View style={styles.infoBarcodeContainer}>
                    ...
                    <ThemedText
                      style={[styles.infoBarcodeValue, { color: theme.text }]}
                    >
                      {info.barcodeValue}
                    </ThemedText>
                    {info.content.includes(" - ") ? (
                      <ThemedText
                        style={[styles.infoContent, { marginTop: Spacing.sm }]}
                      >
                ...
                <ThemedText
                  style={[styles.infoAuthor, { color: theme.textSecondary }]}
                >
              ...
              >
                <View style={styles.infoHeader}>
                  ...
                  >
                    ...
                    <ThemedText
                      style={[styles.statusText, { color: theme.pending }]}
                    >
                      Ausstehend
                    </ThemedText>
                  </View>
            ...
            >
              ...
              <View style={styles.modalButtons}>
                ...
                <Button
                  ...
                  style={styles.saveButton}
                  disabled={
                    !editName.trim() || !editAddress.trim() || !editCity.trim()
                  }
                >
                  Speichern
                </Button>
      ...
      >
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            <View
              style={[styles.infoBox, { backgroundColor: theme.error + "15" }]}
            >
              <Feather name="alert-triangle" size={16} color={theme.error} />
              <ThemedText style={[styles.infoBoxText, { color: theme.error }]}>
                Diese Aktion kann nicht rueckgaengig gemacht werden! Alle Daten
                zu diesem Markt werden unwiderruflich geloescht.
              </ThemedText>
            </View>

            <ThemedText
              style={[styles.deleteConfirmText, { color: theme.text }]}
            >
              Moechten Sie den Markt &quot;{market.name}&quot; wirklich
              loeschen?
            </ThemedText>
